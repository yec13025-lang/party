    ...
    return function t(e, r, n) {
        ...
        16: [function (t, e, r) {
            ...
            function f(t, e, r) {
                ...
                var o = g.getSymbolTotalCodewords(t), i = E.getTotalCodewordsCount(t, e), a = 8 * (o - i);
            ...
            function l(t, e, r) {
                for (var n = g.getSymbolTotalCodewords(e), o = E.getTotalCodewordsCount(e, r), i = n - o, a = E.getBlocksCount(e, r), u = n % a, s = a - u, f = Math.floor(n / a), l = Math.floor(i / a), c = l + 1, d = f - l, p = new b(d), v = 0, m = new Array(a), w = new Array(a), y = 0, A = new h(t.buffer), B = 0; B < a; B++) {
                    var R = B < s ? l : c;
                    m[B] = A.slice(v, v + R), w[B] = p.encode(m[B]), v += R, y = Math.max(y, R)
                }
                var P, T, C = new h(n), N = 0;
                for (P = 0; P < y; P++) for (T = 0; T < a; T++) P < m[T].length && (C[N++] = m[T][P]);
                for (P = 0; P < d; P++) for (T = 0; T < a; T++) C[N++] = w[T][P];
                return C
            }
            ...
            function c(t, e, r, l) {
                ...
                var m = f(e, r, c), w = g.getSymbolSize(e), E = new v(w);
                return n(E, e), o(E), i(E, e), u(E, r, 0), e >= 7 && a(E, e), s(E, m), l || (l = y.getBestMask(E, u.bind(null, E, r))), y.applyMask(l, E), u(E, r, l), {
                    modules: E,
                    version: e,
            ...
            var h = t("../utils/buffer"), g = t("./utils"), d = t("./error-correction-level"), p = t("./bit-buffer"),
            ...
            r.create = function (t, e) {
                ...
                var r, n, o = d.M;
                return void 0 !== e && (o = d.from(e.errorCorrectionLevel, d.M), r = A.from(e.version), n = y.from(e.maskPattern), e.toSJISFunc && g.setToSJISFunction(e.toSJISFunc)), c(t, r, o, n)
            }
        }, {
            "../utils/buffer": 26,
            "./alignment-pattern": 1,
        ...
        19: [function (t, e, r) {
            ...
            function i(t) {
                ...
                return m.isKanjiModeEnabled() ? (e = o(v.BYTE, c.BYTE, t), r = o(v.KANJI, c.KANJI, t)) : (e = o(v.BYTE_KANJI, c.BYTE, t), r = []), n.concat(i, e, r).sort(function (t, e) {
                ...
                for (var r = {}, n = {start: {}}, o = ["start"], i = 0; i < t.length; i++) {
                    for (var u = t[i], s = [], f = 0; f < u.length; f++) {
                        ...
                        for (var g = 0; g < o.length; g++) {
                            var d = o[g];
                            r[d] && r[d].node.mode === l.mode ? (n[d][h] = a(r[d].lastCount + l.length, l.mode) - a(r[d].lastCount, l.mode), r[d].lastCount += l.length) : (r[d] && (r[d].lastCount = l.length), n[d][h] = a(l.length, l.mode) + 4 + c.getCharCountIndicator(l.mode, e))
                        }
                    }
                    o = s
                }
            ...
            function l(t, e) {
                ...
                switch (r !== c.KANJI || m.isKanjiModeEnabled() || (r = c.BYTE), r) {
                    case c.NUMERIC:
                        return new h(t);
                    case c.ALPHANUMERIC:
                        return new g(t);
            ...
            var c = t("./mode"), h = t("./numeric-data"), g = t("./alphanumeric-data"), d = t("./byte-data"),
            ...
            r.fromArray = function (t) {
                ...
                for (var n = i(t, m.isKanjiModeEnabled()), o = s(n), a = f(o, e), l = w.find_path(a.map, "start", "end"), c = [], h = 1; h < l.length - 1; h++) c.push(a.table[l[h]].node);
        ...
        }, {"./error-correction-code": 6, "./error-correction-level": 7, "./mode": 13, "./utils": 20, isarray: 28}],
        22: [function (t, e, r) {
            ...
            var o = t("./core/qrcode"), i = t("./renderer/canvas"), a = t("./renderer/svg-render.js");
        ...
        }, {"./core/qrcode": 16, "./renderer/canvas": 23, "./renderer/svg-render.js": 24}],
        23: [function (t, e, r) {
            function n(t, e, r) {
            ...
            r.render = function (t, e, r) {
                ...
                var s = (t.modules.size + 2 * a.margin) * a.scale, f = u.getContext("2d"), l = f.createImageData(s, s);
        ...
        24: [function (t, e, r) {
            ...
            r.render = function (t, e) {
                var r = o.getOptions(e), i = t.modules.size, a = t.modules.data, u = (i + 2 * r.margin) * r.scale,
                ...
                for (var f = 0; f < i; f++) for (var l = 0; l < i; l++) if (a[f * i + l]) {
                    var c = (r.margin + l) * r.scale, h = (r.margin + f) * r.scale;
        ...
        25: [function (t, e, r) {
            function n(t) {
                ...
                return {r: r >> 24 & 255, g: r >> 16 & 255, b: r >> 8 & 255, a: 255 & r}
            }
            ...
            r.getOptions = function (t) {
                ...
                for (var i = e.modules.size, a = e.modules.data, u = r * n, s = i * n + 2 * u, f = [o.light, o.dark], l = 0; l < s; l++) for (var c = 0; c < s; c++) {
                    var h = 4 * (l * s + c), g = o.light;
                    if (l >= u && c >= u && l < s - u && c < s - u) {
                        var d = Math.floor((l - u) / n), p = Math.floor((c - u) / n);
                        g = f[a[d * i + p] ? 1 : 0]
                    }
        ...
        26: [function (t, e, r) {
            ...
            function s(t, e) {
                var r = 0 | g(e), n = a(t, r), o = n.write(e);
        ...
        27: [function (t, e, r) {
            ...
            var n = {
                single_source_shortest_paths: function (t, e, r) {
                    ...
                    a.push(e, 0);
                    for (var u, s, f, l, c, h, g, d; !a.empty();) {
                        u = a.pop(), s = u.value, l = u.cost, c = t[s] || {};
                        for (f in c) c.hasOwnProperty(f) && (h = c[f], g = l + h, d = i[f], (void 0 === i[f] || d > g) && (i[f] = g, a.push(f, g), o[f] = s))
                    }
